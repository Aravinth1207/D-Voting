    ...
    return (
      <div className="container-item">
        <div className="candidate-info">
          ...
          <p className="slogan">Party :{candidate.slogan}</p>
        </div>
        <div className="vote-btn-container">
          <button
            ...
            style={this.state.currentVoter.hasVoted ? { backgroundColor: 'gray', cursor: 'not-allowed' } : { backgroundColor: '#4bb543' }}
          >
            Vote
          </button>
        </div>
      ...
      <>
        ...
        <div>
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <>
              <div className="container-item attention">
                <center> <h2>The Election ended.</h2></center>
                <br />
                <center>
                  <Link
                    to="/Results"
